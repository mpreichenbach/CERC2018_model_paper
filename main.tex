...
\section{Modeling Framework}
	...
	\subsection{Covariates}
		...
		where $i$ is the number of covariates to include in a formula. For the sound repetitions with a sunrise or sunset, we use all five covariates, so $n = 5$ covariates; otherwise, we ignore the formulas with Diel, and so $n = 4$.
